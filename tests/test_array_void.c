...
void test_create_int_object_array(void)
{
  ...
  assert(*(Int_Ptr)object_array->array[0] == 1);
  assert(*(Int_Ptr)object_array->array[1] == 2);
...
void test_map_void(void)
{
  ...
  assert(*(Int_Ptr)mapped_array1->array[0] == 2);
  assert(*(Int_Ptr)mapped_array1->array[1] == 3);
...
void test_filter_void(void)
{
  ...
  assert(*(Int_Ptr)filtered_array1->array[0] == 2);
  printf("\t\t--passed\n\n");
...
void test_reduce_void(void)
{
  ...
  *(Int_Ptr)init = 0;
  ...
  int src1[] = {1, 2};
  assert(*(Int_Ptr)reduce_void(create_int_object_array(src1, 2), init, &add_int_objects) == 3);
  printf("\t\t--passed\n\n");

  printf("\tShould give 0 as the array is empty\n");
  int src2[] = {};
  assert(*(Int_Ptr)reduce_void(create_int_object_array(src2, 0), init, &add_int_objects) == 0);
  printf("\t\t--passed\n\n");
}